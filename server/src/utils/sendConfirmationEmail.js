...
const sendConfirmationEmail = async ({
  ...
  const teamLine = teamName
    ? `<tr style="border-bottom:1px solid #ede3d3;"><td class="table-cell-pad" style="padding:11px 16px;color:#7a6245;font-size:13.5px;font-weight:600;">Team Name</td><td class="table-cell-pad" style="padding:11px 16px;color:#1a1208;font-size:14px;font-weight:600;">${teamName}</td></tr>`
    : '';

  const memberLine = memberCount && memberCount > 1
    ? `<tr style="border-bottom:1px solid #ede3d3;"><td class="table-cell-pad" style="padding:11px 16px;color:#7a6245;font-size:13.5px;font-weight:600;">Team Size</td><td class="table-cell-pad" style="padding:11px 16px;color:#1a1208;font-size:14px;font-weight:600;">${memberCount} Members</td></tr>`
    : '';
...
<body class="email-wrapper" style="margin:0;padding:24px 12px;background-color:#f4efe6;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#2c1e0e;">
  <div class="email-card" style="max-width:600px;margin:0 auto;background-color:#fdfbf7;border:1.5px solid #d4af37;border-radius:10px;box-shadow:0 6px 24px rgba(78,52,21,0.08);overflow:hidden;">
    ...
    <div class="content-box" style="padding:30px 24px;">
      ...
      <h2 class="mobile-status-title" style="text-align:center;color:#2c1e0e;font-size:21px;margin:0 0 6px;letter-spacing:1px;font-weight:800;">REGISTRATION CONFIRMED</h2>
      <p style="text-align:center;color:#7a6245;font-size:13.5px;margin:0 0 22px;">Your entry into the trials has been sealed.</p>
      ...
      <p style="color:#3e2d1a;font-size:14.5px;line-height:1.65;margin:0 0 20px;">
        Your registration for <strong style="color:#8a5a1f;">${eventName}</strong> has been successfully recorded and confirmed in the cosmic archives.
      </p>
      ...
      <table style="width:100%;border-collapse:collapse;margin:20px 0;background:#fbf7ee;border:1px solid #e5d8c3;border-radius:8px;overflow:hidden;">
        <tr style="border-bottom:1px solid #ede3d3;">
          <td class="table-cell-pad" style="padding:11px 16px;color:#7a6245;font-size:13.5px;font-weight:600;">Pass ID</td>
        ...
        ${memberLine}
        <tr style="border-bottom:1px solid #ede3d3;">
          <td class="table-cell-pad" style="padding:11px 16px;color:#7a6245;font-size:13.5px;font-weight:600;">Registration Fee</td>
          <td class="table-cell-pad" style="padding:11px 16px;color:#1a1208;font-size:14px;font-weight:600;">
            ${paymentRequired ? `₹${payableAmount} (Payment required)` : '₹0 (No payment required — PCCOE Eligible)'}
          </td>
        </tr>
        <tr>
          <td class="table-cell-pad" style="padding:11px 16px;color:#7a6245;font-size:13.5px;font-weight:600;">Status</td>
      ...
      <div style="background:#fbf7ee;border:1px solid #e5d8c3;border-radius:8px;padding:18px;margin:22px 0;">
        <h3 style="color:#8c5d1e;font-size:13px;margin:0 0 10px;letter-spacing:1px;font-weight:800;text-transform:uppercase;">Instructions for Event Day</h3>
        <ul style="margin:0;padding:0 0 0 18px;color:#4a3823;font-size:13px;line-height:1.75;">
          <li>Present your <strong style="color:#1a1208;">Pass ID: ${registrationId}</strong> at the registration desk for on-venue verification.</li>
