      ...
      <div className="footer-container">
        ...
        <div className="footer-left">
          <div className="footer-logos-grid">
            {/* Logo 1: AIMSA */}
            <div className="footer-logo-box aimsa-box">
              <span className="logo-text-aimsa">AIMSA</span>
            </div>

            {/* Logo 2: Campus Buzz */}
            <div className="footer-logo-circle">
              <span className="logo-symbol-cb">CB</span>
            </div>

            {/* Logo 3: Student Network */}
            <div className="footer-logo-circle dark-blue">
              <span className="logo-symbol-net">🌐</span>
            </div>

            {/* Logo 4: AAAI Chapter */}
            <div className="footer-logo-circle">
              <div className="logo-stacked-text">
                <strong>AAAI</strong>
                <small>CHAPTER</small>
              </div>
            </div>
            ...
            {/* Logo 6: Tech Club */}
            <div className="footer-logo-circle gold-accent">
              <span className="logo-symbol-star">✦</span>
            </div>
          </div>
